...
class MarketService {
    constructor(flowService, fungibleTokenAddress, kibbleAddress, nonFungibleTokenAddress, kittyItemsAddress, marketAddress) {
        ...
        this.addSaleOffer = (saleOfferEvent) => __awaiter(this, void 0, void 0, function* () {
            return sale_offer_1.SaleOffer.transaction((tx) => __awaiter(this, void 0, void 0, function* () {
                return yield sale_offer_1.SaleOffer.query(tx)
                    .insert({
        ...
        this.findMostRecentSales = () => {
            return sale_offer_1.SaleOffer.transaction((tx) => __awaiter(this, void 0, void 0, function* () {
                const offers = yield sale_offer_1.SaleOffer.query(tx).select("*");
                return offers;
            }));
        };
    }
